...
{
  int32_t ret;
  uint8_t volatile data[4] = {ILI9341_READ_ID4, 0, 0, 0 };
...
{
  uint8_t volatile reg = ILI9341_DISPLAY_ON;
...
{
  uint8_t volatile reg = ILI9341_DISPLAY_OFF;
...
int32_t ILI9341_SetDisplayWindow(ILI9341_Object_t *pObj, uint32_t Xpos, uint32_t Ypos, uint32_t Width, uint32_t Height)
{
  int32_t ret;
  uint8_t volatile parameter[4];
  uint8_t volatile reg = ILI9341_CASET;
