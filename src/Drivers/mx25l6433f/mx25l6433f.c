...
{
  int32_t ret = MX25L6433F_OK;
  uint8_t volatile cmd = MX25L6433F_CHIP_ERASE_CMD;
...
{
  int32_t ret = MX25L6433F_OK;
  uint8_t volatile cmd = MX25L6433F_READ_ID_CMD;
  uint8_t volatile id[4] = {0x00, 0x00, 0x00, 0x00};
...
{
  int32_t ret = MX25L6433F_OK;
  uint8_t volatile cmd = MX25L6433F_WRITE_ENABLE_CMD;
...
{
  int32_t ret = MX25L6433F_OK;
  uint8_t volatile cmd = MX25L6433F_WRITE_DISABLE_CMD;
...
{
  int32_t ret = MX25L6433F_OK;
  uint8_t volatile cmd = MX25L6433F_READ_STATUS_REG_CMD;
...
{
  int32_t ret = MX25L6433F_OK;
  uint8_t volatile cmd[2] = {MX25L6433F_WRITE_STATUS_CFG_REG_CMD, Value};
...
int32_t MX25L6433F_WriteBurstReadLength(MX25L6433F_Object_t *pObj, uint8_t Value)
{
  ...
  uint8_t volatile cmd[2] = { MX25L6433F_SET_BURST_LENGTH_CMD, Value};
...
{
  int32_t ret = MX25L6433F_OK;
  uint8_t volatile cmd = MX25L6433F_RESET_ENABLE_CMD;
...
{
  int32_t ret = MX25L6433F_OK;
  uint8_t volatile cmd = MX25L6433F_RESET_MEMORY_CMD;
