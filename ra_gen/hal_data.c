...
gpt_instance_ctrl_t LCD_timer_ctrl;
#if 0
const gpt_extended_pwm_cfg_t LCD_timer_pwm_extend =
{
...
#endif
const gpt_extended_cfg_t LCD_timer_extend =
        { .gtioca =
...
#if 0
    .p_pwm_cfg                   = &LCD_timer_pwm_extend,
#else
          .p_pwm_cfg = NULL,
#endif
#if 0
...
const timer_cfg_t LCD_timer_cfg =
{ .mode = TIMER_MODE_PERIODIC,
/* Actual period: 0.00004 seconds. Actual duty: 50%. */.period_counts = (uint32_t) 0x12c0,
  .duty_cycle_counts = 0x960, .source_div = (timer_source_div_t) 0, .channel = 8, .p_callback = NULL,
...
const timer_instance_t LCD_timer =
{ .p_ctrl = &LCD_timer_ctrl, .p_cfg = &LCD_timer_cfg, .p_api = &g_timer_on_gpt };
...
spi_b_instance_ctrl_t LCD_spi0_ctrl;

/** SPI extended configuration for SPI HAL driver */
const spi_b_extended_cfg_t LCD_spi0_ext_cfg =
...
{ .channel = 0,
  ...
  .p_transfer_tx = LCD_spi0_P_TRANSFER_TX,
  .p_transfer_rx = LCD_spi0_P_TRANSFER_RX,
  .p_callback = LCD_spi_callback,

  .p_context = NULL,
  .p_extend = (void*) &LCD_spi0_ext_cfg, };

/* Instance structure to use this module. */
const spi_instance_t LCD_spi0 =
{ .p_ctrl = &LCD_spi0_ctrl, .p_cfg = &LCD_spi0_cfg, .p_api = &g_spi_on_spi_b };
sci_b_uart_instance_ctrl_t log_uart0_ctrl;

sci_b_baud_setting_t log_uart0_baud_setting =
        {
...
const sci_b_uart_extended_cfg_t log_uart0_cfg_extend =
{ .clock = SCI_B_UART_CLOCK_INT, .rx_edge_start = SCI_B_UART_START_BIT_FALLING_EDGE, .noise_cancel =
  ...
  .rx_fifo_trigger = SCI_B_UART_RX_FIFO_TRIGGER_MAX, .p_baud_setting = &log_uart0_baud_setting, .flow_control =
...
const uart_cfg_t log_uart0_cfg =
{ .channel = 0, .data_bits = UART_DATA_BITS_8, .parity = UART_PARITY_OFF, .stop_bits = UART_STOP_BITS_1, .p_callback =
          log_uart_callback,
  .p_context = NULL, .p_extend = &log_uart0_cfg_extend,
...
/* Instance structure to use this module. */
const uart_instance_t log_uart0 =
{ .p_ctrl = &log_uart0_ctrl, .p_cfg = &log_uart0_cfg, .p_api = &g_uart_on_sci_b };
